...
![Every damn time](ocean_activities_bar.jpeg)
Literally every time this is what it shows me. If you can figure out how to reorder this to the following order (on the x axis), I will buy you so much cider and bacon you wont know what to do with it all: "wind", "wave", "aquaculture", "tidal", "other".
...
types <- read_csv(here("data_types_tidy.csv"))
```
